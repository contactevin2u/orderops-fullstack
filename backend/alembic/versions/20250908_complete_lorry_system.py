...
def upgrade():
    ...
    if 'lorries' not in existing_tables:
    ...
    # Create lorry_stock_transactions table (only if it doesn't exist)
    if 'lorry_stock_transactions' not in existing_tables:
    ...
    # Add priority_lorry_id to drivers table (only if column doesn't exist)
